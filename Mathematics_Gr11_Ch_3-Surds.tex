...
\end{eqnarray*}
\westep{Move the squared ($^{2}$) values inside the surd to the outside of the square root sign}
\begin{eqnarray*}
&=& 7\sqrt{3} + 6\sqrt{3}
\end{eqnarray*}
...
\westep{Multiply this equation by a ``clever'' form of $1$ that would rationalise this denominator}
    \begin{equation*}
