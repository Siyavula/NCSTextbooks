\chapter{Solving Quadratic Equations - Grade 11}
\label{m:se:q11}
...
\westep{Put both sides over the LCM}
...
\equ{f(x)=a(x^2+\frac{b}{a}x+\frac{c}{a}).}{eq:cts:ex2}
...
\nequ{(x+\frac{b}{2a})^2 = x^2 + 2\frac{b}{2a}x + (\frac{b}{2a})^2.}
...
\item{[IEB, Nov. 2001, HG] Given: \quad $x^2 + bx -2 + k(x^2 + 3x + 2) = 0 \qquad (k \ne -1)$
\begin{enumerate}
