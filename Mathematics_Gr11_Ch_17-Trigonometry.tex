...
\end{pspicture}
\caption{The graph of $\tan(2\theta)$ (solid line) and the graph of $g(\theta)=\tan(\theta)$ (dotted line). The asymptotes are shown as dashed lines.}
...
\multirput(-360,0)(180,0){5}{\tanx}
\end{pspicture}
\caption{The graph of $\tan(\theta+30^{\circ})$  (solid lines) and the graph of $g(\theta)=\tan(\theta)$ (dotted lines).}
...
So, we have:
\begin{eqnarray*}
\sin(45^\circ)&=&\frac{\rm{opposite(45^\circ)}}{\rm{hypotenuse}}\\
&=&\frac{a}{\sqrt{2}a}\\
&=&\frac{1}{\sqrt{2}}
\end{eqnarray*}

\begin{eqnarray*}
\cos(45^\circ)&=&\frac{\rm{adjacent(45^\circ)}}{\rm{hypotenuse}}\\
&=&\frac{a}{\sqrt{2}a}\\
&=&\frac{1}{\sqrt{2}}
\end{eqnarray*}

\begin{eqnarray*}
\tan(45^\circ)&=&\frac{\rm{opposite(45^\circ)}}{\rm{adjacent(45^\circ)}}\\
&=&\frac{a}{a}\\
&=&1
\end{eqnarray*}
...
\begin{eqnarray*}
\sin(30^\circ)&=&\frac{\rm{opposite(30^\circ)}}{\rm{hypotenuse}}\\
&=&\frac{\frac{a}{2}}{a}\\
&=&\frac{1}{2}
\end{eqnarray*}

\begin{eqnarray*}
\cos(30^\circ)&=&\frac{\rm{adjacent(30^\circ)}}{\rm{hypotenuse}}\\
&=&\frac{\frac{\sqrt{3}}{2}a}{a}\\
&=&\frac{\sqrt{3}}{2}
\end{eqnarray*}

\begin{eqnarray*}
\tan(30^\circ)&=&\frac{\rm{opposite(30^\circ)}}{\rm{adjacent(30^\circ)}}\\
...
\begin{minipage}{0.4\textwidth}
\begin{eqnarray*}
\sin(60^\circ)&=&\frac{\rm{opposite(60^\circ)}}{\rm{hypotenuse}}\\
&=&\frac{\frac{\sqrt{3}}{2}a}{a}\\
&=&\frac{\sqrt{3}}{2}
\end{eqnarray*}

\begin{eqnarray*}
\cos(60^\circ)&=&\frac{\rm{adjacent(60^\circ)}}{\rm{hypotenuse}}\\
&=&\frac{\frac{a}{2}}{a}\\
&=&\frac{1}{2}
\end{eqnarray*}

\begin{eqnarray*}
\tan(60^\circ)&=&\frac{\rm{opposite(60^\circ)}}{\rm{adjacent(60^\circ)}}\\
...
{
\begin{pspicture}(0,-1.2989062)(6.641875,1.2789062)
\psline[linewidth=0.04cm](3.02,1.2589062)(3.02,-0.74109375)
\psline[linewidth=0.04cm](3.02,-0.74109375)(0.0,-0.74109375)
\psline[linewidth=0.04cm](3.02,1.2589062)(0.0,-0.74109375)
\psline[linewidth=0.04cm](4.02,-0.74109375)(6.02,-0.74109375)
\psline[linewidth=0.04cm](6.02,-0.74109375)(6.02,1.2589062)
\psline[linewidth=0.04cm](6.02,1.2589062)(4.02,-0.74109375)
\usefont{T1}{ptm}{m}{n}
\rput(0.8514063,-0.51109374){$30^\circ$}
\usefont{T1}{ptm}{m}{n}
\rput(2.7114062,0.68890625){$60^\circ$}
\usefont{T1}{ptm}{m}{n}
\rput(4.6714063,-0.49109375){$45^\circ$}
\usefont{T1}{ptm}{m}{n}
\rput(5.751406,0.60890627){$45^\circ$}
\usefont{T1}{ptm}{m}{n}
\rput(6.186875,0.12890625){1}
\usefont{T1}{ptm}{m}{n}
\rput(4.986875,-1.0310937){1}
\usefont{T1}{ptm}{m}{n}
\rput(4.751406,0.46890625){$\sqrt{2}$}
\usefont{T1}{ptm}{m}{n}
\rput(3.186875,0.16890626){1}
\usefont{T1}{ptm}{m}{n}
\rput(1.5114063,-1.0710938){$\sqrt{3}$}
\usefont{T1}{ptm}{m}{n}
\rput(1.2985938,0.44890624){2}
\end{pspicture} 
}
}
...
\nequ{\tan \theta=\frac{\rm{opposite}}{\rm{adjacent}}}
This can be written as:
\begin{eqnarray*}
\tan \theta&=&\frac{\rm{opposite}}{\rm{adjacent}} \times \frac{\rm{hypotenuse}}{\rm{hypotenuse}}\\
&=&\frac{\rm{opposite}}{\rm{hypotenuse}} \times \frac{\rm{hypotenuse}}{\rm{adjacent}}
\end{eqnarray*}

But, we also know that $\sin \theta$ is defined as:
\nequ{\sin \theta=\frac{\rm{opposite}}{\rm{hypotenuse}}}
and that $\cos \theta$ is defined as:
\nequ{\cos \theta=\frac{\rm{adjacent}}{\rm{hypotenuse}}}

Therefore, we can write
\begin{eqnarray*}
\tan \theta&=&\frac{\rm{opposite}}{\rm{hypotenuse}} \times \frac{\rm{hypotenuse}}{\rm{adjacent}}\\
...
&=&\frac{AC^2+AB^2}{BC^2}\\
&=&\frac{BC^2}{BC^2}\quad\quad(\mbox{\rm{from Pythagoras}})\\
&=&1
\end{eqnarray*}
...
\usefont{T1}{ptm}{m}{n}
\rput(8.034219,-0.255){\textit{x}}
\usefont{T1}{ptm}{m}{n}
\rput(3.7242188,3.905){\textit{y}}
\usefont{T1}{ptm}{m}{n}
...
\begin{eqnarray*}
\sin 293^\circ &=& -0,92\cdots \\
-\sin 67^\circ &=& -0,92\cdots
\end{eqnarray*}
}%answer
\end{wex}
...
\usefont{T1}{ptm}{m}{n}
\rput(8.008438,-0.255){\textit{x}}
\usefont{T1}{ptm}{m}{n}
\rput(3.6984375,3.905){\textit{y}}
\usefont{T1}{ptm}{m}{n}
...
In the domain for $\theta$ of $-720^{\circ}<\theta<720^{\circ}$, there are 8 possible solutions for the equation $\sin \theta = 0,5$. These are $\theta=[-690^{\circ}, -570^{\circ}, -330^{\circ}, -210^{\circ}, 30^{\circ}, 150^{\circ}, 390^{\circ}, 510^{\circ}]$
...
In figure \ref{fig:trig:sinesign} we have split the sine graph into four \emph{quadrants}, each $90^\circ$ wide. We call them quadrants because they correspond to the four quadrants of the unit circle. We notice from figure \ref{fig:trig:sinesign} that the sine graph is positive in the 1$^\mathrm{st}$ and 2$^\mathrm{nd}$ quadrants and negative in the 3$^\mathrm{rd}$ and 4$^\mathrm{th}$. Figure \ref{fig:trig:costansign} shows similar graphs for cosine and tangent.
...
\end{minipage}\\
\begin{eqnarray*}
\mathrm{I:} \quad \theta &=& 17,46^{\circ} + 360^{\circ}\cdot n, n \in \mathbb{Z}  \\
\mathrm{II:} \quad \theta &=& 180^{\circ} - 17,46^{\circ} + 360^{\circ}\cdot n, n \in \mathbb{Z} \\
&=& 162,54^{\circ} + 360^{\circ}\cdot n, n \in \mathbb{Z}
\end{eqnarray*}
...
Let us try to solve $\tan(2x-10^\circ)=2,5$ in the range $-360^\circ \leq x \leq 360^\circ$. We want solutions for positive tangent so using our CAST diagram we know to look in the 1$^\mathrm{st}$ and 3$^\mathrm{rd}$ quadrants. Our calculator tells us that $\arctan(2,5)=68,2^\circ$. This is our reference angle. So to find the general solution we proceed as follows:
 ...
 x&=&39,1^{\circ}+90^{\circ}\cdot n, n \in \mathbb{Z} \\
\end{eqnarray*}
...
\cos(\theta-15^{\circ}) &=& -0,5276...\\
\mbox{reference angle: }(\theta-15^{\circ}) &=& 58,2^{\circ}\\ 
\mathrm{II:} \quad \theta-15^{\circ}&=&180^{\circ}-58,2^{\circ}+360^{\circ}\cdot n,\; n\in\mathbb{Z} \\ 
\theta&=&136,8^{\circ}+360^{\circ}\cdot n,\; n \in \mathbb{Z} \\ 
\mathrm{III:} \quad \theta-15^{\circ}&=&180^{\circ}+58,2^{\circ}+360^{\circ}\cdot n,\; n\in\mathbb{Z} \\ 
\theta&=&253,2^{\circ}+360^{\circ}\cdot n,\; n \in \mathbb{Z} \\ 
\end{eqnarray*}
}
\end{wex}
...
\begin{eqnarray*}
(y + 1)(y + 2) = 0 \\
\Rightarrow y = -1 \hspace{0.5cm} \mathrm{OR} \hspace{0.5cm} y = -2 \\
\end{eqnarray*}
Next we just substitute back for the temporary variable:
\[ \tan{(2x + 1)} = -1 \hspace{0.5cm} \mathrm{or} \hspace{0.5cm} \tan{(2x + 1)} = -2 \]
...
\[ \cos{(2x + 1)} = -1 \hspace{0.5cm} \mathrm{or} \hspace{0.5cm} \cos{(2x + 1)} = -2 \]
...
Factorising yields
\[(2y+1)(y-1)=0 \]
\[\therefore \quad y = -0,5 \quad \mathrm{or} \quad y=1 \]
}

\westep{Substitute back and solve the two resulting equations}
We thus get
\[ \quad \cos x = -0,5 \quad \mathrm{or} \quad \cos x=1 \]
...
\mathrm{II:} \quad x &=& 180^\circ - 60^\circ +360^\circ\cdot n, n\in\mathbb{Z}\\
&=& 120^\circ +360^\circ\cdot n, n\in\mathbb{Z}\\
\mathrm{III:} \quad x &=& 180^\circ + 60^\circ +360^\circ\cdot n, n\in\mathbb{Z}\\
&=& 240^\circ +360^\circ\cdot n, n\in\mathbb{Z}
\end{eqnarray*}
\end{minipage}
\begin{minipage}{0.5\textwidth}
\begin{eqnarray*}
\cos x &=& 1 \quad [90^\circ] \\
\mathrm{I; IV:} \quad x &=& 0^\circ  +360^\circ\cdot n, n\in\mathbb{Z}\\
&=& 360^\circ\cdot n, n\in\mathbb{Z}
\end{eqnarray*}
\end{minipage}\\
...
\begin{eqnarray*}
 \sin x & = & 0 \quad [0^\circ]\\
\therefore \quad x &=& 180^\circ\cdot n, n\in\mathbb{Z}
\end{eqnarray*}
\end{minipage}
\begin{minipage}{0.5\textwidth}
\begin{eqnarray*}
\tan x &=& \tfrac{1}{2} \quad [26,57^\circ]\\
\mathrm{I;III:} \quad x &=& 26,57^\circ +  180^\circ\cdot n, n\in\mathbb{Z} 
\end{eqnarray*}
\end{minipage}\\
...
\item
	\begin{enumerate}
	\item Solve for A if $\sin (\mathrm{A}+20^\circ) = 0,53$
...
\nequ{\rm{area}\quad \triangle ABC = \frac{1}{2}c\cdot h.}
...
\nequ{\frac{1}{2}c\cdot h=\frac{1}{2}c \cdot b\cdot \sin \hat{A} = \frac{1}{2}c \cdot a\cdot \sin \hat{B}}
...
We need to know the lengths of the two sides $\mathrm{AC}$ and $\mathrm{BC}$. We can use the sine rule to find our missing lengths. 
...
\item Find all the unknown sides and angles of the following triangles:
	\begin{enumerate}
	\item $\triangle$PQR in which $\hat{\mathrm{Q}} = 64^\circ$; $\hat{\mathrm{R}} = 24^\circ$ and $r=3$
	\item $\triangle$KLM in which $\hat{\mathrm{K}} = 43^\circ$; $\hat{\mathrm{M}} = 50^\circ$ and $m=1$
	\item $\triangle$ABC in which $\hat{\mathrm{A}} = 32,7^\circ$; $\hat{\mathrm{C}} = 70,5^\circ$ and $a=52,3$
	\item $\triangle$XYZ in which $\hat{\mathrm{X}} = 56^\circ$; $\hat{\mathrm{Z}} = 40^\circ$ and $x=50$
	\end{enumerate}
\item In $\triangle$ABC, $\hat{\mathrm{A}} = 116^\circ$;  $\hat{\mathrm{C}} = 32^\circ$ and $\mathrm{AC} = 23$~m. Find the length of the side AB.
\item In $\triangle$RST, $\hat{\mathrm{R}} = 19^\circ$;  $\hat{\mathrm{S}} = 30^\circ$ and $\mathrm{RT} = 120$~km. Find the length of the side ST.
\item In $\triangle$KMS, $\hat{\mathrm{K}} = 20^\circ$;  $\hat{\mathrm{M}} = 100^\circ$ and $s = 23$~cm. Find the length of the side m.
\end{enumerate}
}
...
\begin{eqnarray*}
a^2 & = & b^2+c^2 - 2 bd\cos \hat{\mathrm{A}}\\
\therefore \quad \cos \hat{\mathrm{A}} &=& \frac{b^2+c^2-a^2}{2bc}\\
&=& \frac{8^2+5^2-7^2}{2\cdot 8 \cdot 5} \\
&=& 0,5 \\
\therefore \quad \hat{\mathrm{A}} &=& \arccos 0,5 = 60^\circ
\end{eqnarray*}
}%a
\end{wex}
...
\item Solve the following triangles \ie find all unknown sides and angles
	\begin{enumerate}
	\item $\triangle$ABC in which $\hat{\mathrm{A}}= 70^\circ$; $b = 4$ and $c = 9$
	\item $\triangle$XYZ in which $\hat{\mathrm{Y}}= 112^\circ$; $x = 2$ and $y = 3$ 
	\item  $\triangle$RST in which RS$ = 2$; ST$ = 3$ and RT$ = 5$
	\item  $\triangle$KLM in which KL$ = 5$; LM$ = 10$ and KM$ = 7$
	\item  $\triangle$JHK in which $\hat{\mathrm{H}}= 130^\circ$; JH$ = 13$ and HK$ = 8$
	\item  $\triangle$DEF in which $d = 4$; $e =5 $ and $f = 7$
	\end{enumerate}
\item Find the length of the third side of the $\triangle$XYZ where:
	\begin{enumerate}
	\item $\hat{\mathrm{X}}= 71,4^\circ$; $y=3,42$~km and $z=4,03$~km
	\item ; $x=103,2$~cm; $\hat{\mathrm{Y}}= 20,8^\circ$ and $z=44,59$~cm
	\end{enumerate}
...
\nequ{A=\frac{1}{2}DE\cdot EF \sin\hat{E} = \frac{1}{2}EF\cdot FD \sin\hat{F}=\frac{1}{2}FD\cdot DE \sin\hat{D}}
...
{
$\triangle$ABC is isosceles, therefore AB$=$AC$=7$ and $\hat{\mathrm{C}} = \hat{\mathrm{B}}= 50^\circ$. Hence  $\hat{\mathrm{A}} = 180^\circ -50^\circ -50^\circ = 80^\circ$. Now we can use the area rule to find the area:
\begin{eqnarray*}
A &=& \frac{1}{2}cb\sin\hat{\mathrm{A}} \\
...
\begin{enumerate}
\item Find the area of $\triangle$PQR in which: \begin{enumerate} \item $\hat{\mathrm{P}} = 40^{\circ}$; $q=9$ and $r=25$ \item $\hat{\mathrm{Q}} = 30^{\circ}$; $r=10$ and $p=7$ \item $\hat{\mathrm{R}} = 110^{\circ}$; $p=8$ and $q=9$ \end{enumerate}
\item Find the area of: \begin{enumerate} \item $\triangle$XYZ with XY$=6$~cm; XZ$=7$~cm and $\hat{\mathrm{Z}} = 28^{\circ}$ \item $\triangle$PQR with PR$=52$~cm; PQ$=29$~cm and $\hat{\mathrm{P}} = 58,9^{\circ}$ \item $\triangle$EFG with FG$=2,5$~cm; EG$=7,9$~cm and $\hat{\mathrm{G}} = 125^\circ$ \end{enumerate}
...
\item If the area of $\triangle$ABC is $5 000$~m$^2$ with $a=150$~m and $b = 70$~m, what are the two possible sizes of $\hat{\mathrm{C}}$? 
\end{enumerate}
}
...
\\
& $\mathrm{Area}=\frac{1}{2}bc\cos{A}$ &$a^2=b^2+c^2-2bc\cos{A}$ \\
$\frac{\sin{A}}{a}=\frac{\sin{B}}{b}=\frac{\sin{C}}{c}$& $\mathrm{Area}=\frac{1}{2}ac\cos{B}$ & $b^2=a^2+c^2-2ac\cos{B}$ \\
& $\mathrm{Area}=\frac{1}{2}ab\cos{C}$ & $c^2=a^2+b^2-2ab\cos{C}$ \\
\end{tabular}
\end{center}
...
\begin{enumerate}
\begin{minipage}{0.7\textwidth}
\item  Q is a ship at a point 10~km due South of another ship P. R is a lighthouse on the coast such that $\hat{\mathrm{P}} = \hat{\mathrm{Q}} = 50^\circ$.\\
Determine:
\begin{enumerate}
...
\begin{minipage}{0.7\textwidth}
\item WXYZ is a trapezium (WX$\parallel$XZ) with WX$=3$~m; YZ$=1,5$~m;$\hat{\mathrm{Z}} = 120^\circ$ and $\hat{\mathrm{W}} = 30^\circ$
\begin{enumerate}
\item Determine the distances XZ and XY.
\item Find the angle $\hat{\mathrm{C}}$.
\end{enumerate}
\end{minipage}
\begin{minipage}{0.3\textwidth}
\scalebox{0.8} % Change this value to rescale the drawing.
...
\usefont{T1}{ptm}{m}{n}
\rput(0.3559375,-1.2392187){1,5 m}
\usefont{T1}{ptm}{m}{n}
\rput(3.3696876,0){3 m}
...
\end{enumerate}
\begin{minipage}{0.5\textwidth}
\item ABCD is a trapezium (\ie AB$\parallel$CD). AB$=x$; $\mathrm{B\hat{A}D}=a$; $\mathrm{B\hat{C}D}=b$ and $\mathrm{B\hat{D}C}=c$.\\
...
\item A surveyor is trying to determine the distance between points X and Z. However the distance cannot be determined directly as a ridge lies between the two points. From a point Y which is equidistant from X and Z, he measures the angle $\mathrm{X\hat{Y}Z}$.
\begin{enumerate}
\item If XY$=x$ and $\mathrm{X\hat{Y}Z}=\theta$, show that XZ$=x\sqrt{2(1-\cos\theta)}$.
