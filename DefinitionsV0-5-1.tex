...
%    \null
    ...
    \hbox{\mbox{%
        \hspace{4pt}%
        \includegraphics[width=4cm]{../logohighschool.eps}%
        \hspace{4pt}
        }%
...
\vspace{3mm}
\begin{center}
\colorbox{lightgray}{\begin{minipage}[t]{0.95\textwidth}
\rput(-1.5,0){\psflag}\noindent%
...
\vspace{3mm}
\begin{center}
\begin{pspicture}(0,-0.2)(5,0.2)\psline[linewidth=1pt]{-}(0,0)(5,0)
\end{pspicture}
  \begin{quotation} % or save, then modify margin
     \rput(-2.5,0){\psqmark}\noindent%
     \textbf{Exercise: #1}\par #2%
  \end{quotation} % or set margins back to normal
\begin{pspicture}(0,-0.2)(5,0.2)\psline[linewidth=1pt]{-}(0,0)(5,0)
\end{pspicture}
\end{center}
