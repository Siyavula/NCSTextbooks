...
(1.) 01h6 & (2.) 01h7 & (3.) 01h8 & (4.) 01h9 & (5.) 01ha  & 
 \end{tabular}
}
...
Draw the molecule using Lewis notation. Make sure that you draw \textit{all} the valence electrons around the molecule's central atom.\\
...
\Tip{You can remember this by using OiLRiG: Oxidation is Loss Reduction is Gain.}
...
\begin{wex}{Oxidation numbers III}{Give the oxidation number of sulphur in a sulphate ($\text{SO}_{4}^{2-}$) ion}
