...
\rput[tl](7.7,2.275){\small the sun emits short wavelength radiation}
\rput[tl](7.7,1.975){\small which penetrates the atmosphere}
\rput[tl](8.5,0.835){\small CO$_{2}$ molecules absorb and re-emit}
\rput[tl](8.5,0.535){\small the infrared radiation in all directions}
\rput[tl](8.5,0.235){\small heating the atmosphere}
\end{pspicture} 
}
\end{center}
