...
\begin{enumerate}
  ...
  \item Aluminum is melted along with cryolite ($\text{Na}_{3}\text{AlF}_{6}$) which acts as the electrolyte. Cryolite helps to lower the melting point and dissolve the ore.
