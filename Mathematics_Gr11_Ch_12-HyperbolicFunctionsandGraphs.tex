\chapter{Hyperbolic Functions and Graphs - Grade 11}
\label{m:fg:h11}
...
\item{Following the general method of the above activities, choose your own values of $a$ and $p$ to plot 5 different graphs of $y=\frac{a}{x+p} + q$ to deduce the effect of $q$.}
\end{enumerate}}
...
\psplot[plotstyle=curve,arrows=<->]{-5}{-1.4}{x 1 add -1 exp 2 mul 2 add}
\psplot[plotstyle=curve,arrows=<->]{-0.65}{5}{x 1 add -1 exp 2 mul 2 add}
